...
npm run deploy     # build + publicación en rama develop (GitHub Pages)
```
...
| `develop` | Sitio publicado en GitHub Pages |
| `main` | Rama principal del repositorio |

Flujo habitual: desarrollar en `rediseño-2026` → merge a `develop` → `npm run deploy` para publicar.

El comando `deploy` publica el contenido de `dist/` en la rama **`develop`** del repositorio [SoniaDurGom/portfolio](https://github.com/SoniaDurGom/portfolio), desplegado en [soniadurgom.github.io/portfolio](https://soniadurgom.github.io/portfolio).
